...
public class BillOfMaterials {
	 ...
	 * default value is {@code Integer.MAX_VALUE}, indicating lowest priority. The edoras
	 * one dependencies bom has an order of 100.
	 */
	 ...
	 */
	public BillOfMaterials resolve(Version edorasoneVersion) {
		if (mappings.isEmpty()) {
			return this;
		}
		...
		throw new IllegalStateException(
				"No suitable mapping was found for " + this + " and version " + edorasoneVersion);
	}
