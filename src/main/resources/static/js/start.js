...
$(function () {
    ...
    var initializeSearchEngine = function (engine, edorasoneVersion) {
        $.getJSON("/ui/dependencies.json?version=" + edorasoneVersion, function (data) {
            engine.clear();
    ...
    var generatePackageName = function() {
        ...
        var package = groupId.concat(".").concat(shortName)
            .replace(/-/g, '');
    ...
    initializeSearchEngine(starters, $("#edorasoneVersion").val());
