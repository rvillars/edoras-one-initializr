...
package com.edorasware.one.initializr.test.metadata;
...
public class InitializrMetadataTestBuilder {
	...
	public InitializrMetadataTestBuilder addDefaults() {
		return addDefaultTypes().addDefaultPackagings().addDefaultJavaVersions()
				.addDefaultLanguages().addDefaultEdorasoneVersions()
	...
	public InitializrMetadataTestBuilder addEdorasoneVersion(String id, boolean defaultValue) {
		builder.withCustomizer(it -> {
			DefaultMetadataElement element = new DefaultMetadataElement();
			element.setId(id);
			element.setName(id);
